     ...
     */
        ...
        var UI = {
            ...
            pw: {        
                ...
                unmask: document.querySelector('.unmask'),
            },

            seed: {
                output: document.querySelector('.seeds'),        
            }
        ...
        var App = {
            ...
            init: function () {
                ...
                UI.seed.output.textContent = "Compute-Seeds: " + this.SeedsGenerater(UI.pw.input.value);
                UI.machine.io.innerHTML = this.HashEncoding(this.toBase64(this.utf16to8(UI.human.io.textContent)));
            },
            ...
            bindEvents: function () {
                ...
                helpers.addEvent(UI.human.io, "keyup", function (ev) {
                    ...
                    UI.machine.io.innerHTML = _this.HashEncoding(_this.toBase64(_this.utf16to8(UI.human.io.textContent)));
                });

                helpers.addEvent(UI.machine.io, "keyup", function (ev) {
                    UI.human.figure.classList.add("active");
                    UI.human.figure.classList.add("active");
                    UI.human.io.innerHTML = _this.utf8to16(_this.Base64toHuman(_this.HashDecoding(UI.machine.io.textContent)));
                });


                helpers.addEvent(UI.pw.input, "keyup", function (ev) {
                    UI.machine.figure.classList.add("active");
                    var t = setTimeout(function () {
                        clearTimeout(t);
                        UI.machine.figure.classList.remove("active");
                    }, 1000);
                    UI.seed.output.textContent = "Compute-Seeds: " + _this.SeedsGenerater(UI.pw.input.value);
                    UI.machine.io.innerHTML = _this.HashEncoding(_this.toBase64(_this.utf16to8(UI.human.io.textContent)));
                });


                helpers.addEvent(UI.pw.unmask, "click", function (ev) {
                    if (UI.pw.input.type == "password")
                        UI.pw.input.type = "text";
                    else
                        UI.pw.input.type = "password";
                });
            ...
            SeedsGenerater: function (password) {
            ...
            HashEncoding: function (base64data) {
